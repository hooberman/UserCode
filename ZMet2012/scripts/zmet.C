...
TCut weight_TCut(){
  ...
  TCut weight("weight * 9.2 * trgeff * vtxweight * 1.66");
...
*/
  ...
  */       
  ...
  // vars.push_back("pfmet");         xt.push_back("pfmet (GeV)");    n.push_back(6);   xi.push_back(0.);   xf.push_back(300.0);   flavor.push_back("sf"); cuts.push_back(TCut(""));
