...
process.load("Alignment.PeakDecoResiduals.CRAFT10AdunMerged_cff")
...
process.trackerAlignment =  CalibTracker.Configuration.Common.PoolDBESSource_cfi.poolDBESSource.clone(
    #connect = cms.string('sqlite_file:/afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN/MP/MPproduction/mp0104/alignments_MP.db'),
...
#process.TrackerOfflineValidationStandalone.moduleLevelHistsTransient = cms.bool(True)
#process.TFileService.fileName = '/tmp/jdraeger/FridayFullStat/6747624404/AlignmentValidation_CRAFT10AdunMerged.root'#
