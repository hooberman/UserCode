...
// TECEndcap_5->cd();
// TH1F *dwpeak_tec5_0 = cloneHist(h_resXprimeOverTheta_TECDisk_0);
// TH1F *dwpeak_tec5_1 = cloneHist(h_resXprimeOverTheta_TECDisk_1);
// TH1F *dwpeak_tec5_2 = cloneHist(h_resXprimeOverTheta_TECDisk_2);
// TH1F *dwpeak_tec5_3 = cloneHist(h_resXprimeOverTheta_TECDisk_3);
// TH1F *dwpeak_tec5_4 = cloneHist(h_resXprimeOverTheta_TECDisk_4);
// TH1F *dwpeak_tec5_5 = cloneHist(h_resXprimeOverTheta_TECDisk_5);
// TH1F *dwpeak_tec5_6 = cloneHist(h_resXprimeOverTheta_TECDisk_6);
// TH1F *dwpeak_tec5_7 = cloneHist(h_resXprimeOverTheta_TECDisk_7);
// TH1F *dwpeak_tec5_8 = cloneHist(h_resXprimeOverTheta_TECDisk_8);
// TH1F *dwpeak_tec_thin = (TH1F*)dwpeak_tec5_0->Clone();
// dwpeak_tec_thin->Add(dwpeak_tec5_0);
// dwpeak_tec_thin->Add(dwpeak_tec5_0);
// dwpeak_tec_thin->Add(dwpeak_tec5_0);
// dwpeak_tec_thin->Add(dwpeak_tec5_0);
// dwpeak_tec_thin->Add(dwpeak_tec5_0);
// TH1F *dwpeak_tec_thick = (TH1F*)dwpeak_tec5_0->Clone();
// dwpeak_tec_thick->Add(dwpeak_tec5_0);
// dwpeak_tec_thick->Add(dwpeak_tec5_0);
// dwpeak_tec_thick->Add(dwpeak_tec5_0);
// dwpeak_tec_thick->Add(dwpeak_tec5_0);
// dwpeak_tec_thick->Add(dwpeak_tec5_0);
...
MyStrip->cd();
TECEndcap_6->cd();
TH1F *dwpeak_tec6_0 = cloneHist(h_resXprimeOverTheta_TECDisk_0);
TH1F *dwpeak_tec6_1 = cloneHist(h_resXprimeOverTheta_TECDisk_1);
TH1F *dwpeak_tec6_2 = cloneHist(h_resXprimeOverTheta_TECDisk_2);
TH1F *dwpeak_tec6_3 = cloneHist(h_resXprimeOverTheta_TECDisk_3);
TH1F *dwpeak_tec6_4 = cloneHist(h_resXprimeOverTheta_TECDisk_4);
TH1F *dwpeak_tec6_5 = cloneHist(h_resXprimeOverTheta_TECDisk_5);
TH1F *dwpeak_tec6_6 = cloneHist(h_resXprimeOverTheta_TECDisk_6);
TH1F *dwpeak_tec6_7 = cloneHist(h_resXprimeOverTheta_TECDisk_7);
TH1F *dwpeak_tec6_8 = cloneHist(h_resXprimeOverTheta_TECDisk_8);
...
TECEndcap_5->cd();
TH1F *dwdeco_tec5_0 = cloneHist(h_resXprimeOverTheta_TECDisk_0);
TH1F *dwdeco_tec5_1 = cloneHist(h_resXprimeOverTheta_TECDisk_1);
TH1F *dwdeco_tec5_2 = cloneHist(h_resXprimeOverTheta_TECDisk_2);
TH1F *dwdeco_tec5_3 = cloneHist(h_resXprimeOverTheta_TECDisk_3);
TH1F *dwdeco_tec5_4 = cloneHist(h_resXprimeOverTheta_TECDisk_4);
TH1F *dwdeco_tec5_5 = cloneHist(h_resXprimeOverTheta_TECDisk_5);
TH1F *dwdeco_tec5_6 = cloneHist(h_resXprimeOverTheta_TECDisk_6);
TH1F *dwdeco_tec5_7 = cloneHist(h_resXprimeOverTheta_TECDisk_7);
TH1F *dwdeco_tec5_8 = cloneHist(h_resXprimeOverTheta_TECDisk_8);

// fdeco.cd();
// TrackerOfflineValidation->cd();
// MyStrip->cd();
// TECEndcap_6->cd();
// TH1F *dwdeco_tec6_0 = cloneHist(h_resXprimeOverTheta_TECDisk_0);
// TH1F *dwdeco_tec6_1 = cloneHist(h_resXprimeOverTheta_TECDisk_1);
// TH1F *dwdeco_tec6_2 = cloneHist(h_resXprimeOverTheta_TECDisk_2);
// TH1F *dwdeco_tec6_3 = cloneHist(h_resXprimeOverTheta_TECDisk_3);
// TH1F *dwdeco_tec6_4 = cloneHist(h_resXprimeOverTheta_TECDisk_4);
// TH1F *dwdeco_tec6_5 = cloneHist(h_resXprimeOverTheta_TECDisk_5);
// TH1F *dwdeco_tec6_6 = cloneHist(h_resXprimeOverTheta_TECDisk_6);
// TH1F *dwdeco_tec6_7 = cloneHist(h_resXprimeOverTheta_TECDisk_7);
// TH1F *dwdeco_tec6_8 = cloneHist(h_resXprimeOverTheta_TECDisk_8);
...
for(int islice=0;islice<nslices;islice++){
  ...
  //plotHists(dtpeakproj[islice],dtdecoproj[islice],"TOB","DT Time [ns]",-20,20,1,0);
...
if(printgif){
  c1->Print (Form("%s/plots/deltau_deltaw_TOB.gif",dir));
  c2->Print (Form("%s/plots/duvstantheta_TOB.gif",dir));
  c3->Print (Form("%s/plots/duvsdt_TOB.gif",dir));
  c4->Print (Form("%s/plots/dttime_TOB.gif",dir));
  c5->Print (Form("%s/plots/dwslice_TOB.gif",dir));
  c7->Print (Form("%s/plots/dwvsdt_TOB.gif",dir));
  c10->Print(Form("%s/plots/charge_nstrips_TOB.gif",dir));
  c11->Print(Form("%s/plots/chargevsdt_TOB.gif",dir));
  c12->Print(Form("%s/plots/chargeslice_TOB.gif",dir));
  c13->Print(Form("%s/plots/chargevsdtslice_TOB.gif",dir));

  //c6->Print(Form("localjobs/%s/plots/dtslice_TOB.gif",dir));
}
