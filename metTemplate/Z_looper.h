...
class Z_looper
{
	...
	bool isGoodTrack(int, bool usePV = false);
        ...
        bool passMuon_Nominal( int hypIdx );
        bool passMuon_NominalTTbar( int hypIdx );
        bool passMuon_NominalTTbarV2( int hypIdx );
        bool passElectron_ttbarV1( bool isData  , int hypIdx );
        bool passElectron_ttbar( bool isData  , int hypIdx );
        bool passElectron_cand01( int hypIdx );
