...
void makePhotonTemplates::ScanChain (TChain* chain){
  ...
  while ((currentFile = (TFile*)fileIter.Next())){
    ...
    for (unsigned int event = 0 ; event < nEvents; ++event){
      ...
      if( hlt20_ == 1 ){
        ...
        templateWeight = hlt20_prescale_;
        iTrigBin = 0;
      ...
      if( hlt30_ == 1 ){
        ...
        templateWeight = hlt30_prescale_;
        iTrigBin = 1;
      ...
      if( hlt50_ == 1 ){
        ...
        templateWeight = hlt50_prescale_;
        iTrigBin = 2;
      ...
      if( hlt70_ == 1 ){
        ...
        templateWeight = hlt70_prescale_;
        iTrigBin = 3;
  ...
  if (nEventsChain != nEventsTotal)
    ...
    rootdir->cd();
    saveHist("photonTemplates/nov5th_v3/photon_templates_unweighted.root");
    deleteHistos();
...
void makePhotonTemplates::setBranches (TTree* tree){
  ...
  tree->SetBranchAddress("HLT20Cleaned",            &hlt20_              );
  tree->SetBranchAddress("HLT20Cleaned_prescale",   &hlt20_prescale_     );
  tree->SetBranchAddress("HLT30Cleaned",            &hlt30_              );
  tree->SetBranchAddress("HLT30Cleaned_prescale",   &hlt30_prescale_     );
  tree->SetBranchAddress("HLT50Cleaned",            &hlt50_              );
  tree->SetBranchAddress("HLT50Cleaned_prescale",   &hlt50_prescale_     );
  tree->SetBranchAddress("HLT70Cleaned",            &hlt70_              );
  tree->SetBranchAddress("HLT70Cleaned_prescale",   &hlt70_prescale_     );
