...
class makePhotonBabies
{
 ...
 private:
  ...
  Int_t HLT_Photon50_Cleaned_L1R_;
  Int_t HLT_Photon70_Cleaned_L1R_;

  Int_t HLT_prescale_Photon20_Cleaned_L1R_;
  Int_t HLT_prescale_Photon30_Cleaned_L1R_;
  Int_t HLT_prescale_Photon50_Cleaned_L1R_;
  Int_t HLT_prescale_Photon70_Cleaned_L1R_;

  Int_t HLT_Photon20_L1R_;
  Int_t HLT_Photon30_L1R_;
  Int_t HLT_Photon50_L1R_;
  Int_t HLT_Photon70_L1R_;

  Int_t HLT_prescale_Photon20_L1R_;
  Int_t HLT_prescale_Photon30_L1R_;
  Int_t HLT_prescale_Photon50_L1R_;
  Int_t HLT_prescale_Photon70_L1R_;
