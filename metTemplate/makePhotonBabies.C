...
void makePhotonBabies::MakeBabyNtuple (const char* babyFileName)
{
  ...
  //trigger stuff
  babyTree_->Branch("HLT20Cleaned",      &HLT_Photon20_Cleaned_L1R_,     "HLT20Cleaned/I");  
  babyTree_->Branch("HLT30Cleaned",      &HLT_Photon30_Cleaned_L1R_,     "HLT30Cleaned/I");  
  babyTree_->Branch("HLT50Cleaned",      &HLT_Photon50_Cleaned_L1R_,     "HLT50Cleaned/I");  
  babyTree_->Branch("HLT70Cleaned",      &HLT_Photon70_Cleaned_L1R_,     "HLT70Cleaned/I"); 

  babyTree_->Branch("HLT20Cleaned_prescale",      &HLT_prescale_Photon20_Cleaned_L1R_,     "HLT20Cleaned_prescale/I");  
  babyTree_->Branch("HLT30Cleaned_prescale",      &HLT_prescale_Photon30_Cleaned_L1R_,     "HLT30Cleaned_prescale/I");  
  babyTree_->Branch("HLT50Cleaned_prescale",      &HLT_prescale_Photon50_Cleaned_L1R_,     "HLT50Cleaned_prescale/I");  
  babyTree_->Branch("HLT70Cleaned_prescale",      &HLT_prescale_Photon70_Cleaned_L1R_,     "HLT70Cleaned_prescale/I"); 

  babyTree_->Branch("HLT20",      &HLT_Photon20_L1R_,     "HLT20/I");  
  babyTree_->Branch("HLT30",      &HLT_Photon30_L1R_,     "HLT30/I");  
  babyTree_->Branch("HLT50",      &HLT_Photon50_L1R_,     "HLT50/I");  
  babyTree_->Branch("HLT70",      &HLT_Photon70_L1R_,     "HLT70/I"); 

  babyTree_->Branch("HLT20_prescale",      &HLT_prescale_Photon20_L1R_,     "HLT20_prescale/I");  
  babyTree_->Branch("HLT30_prescale",      &HLT_prescale_Photon30_L1R_,     "HLT30_prescale/I");  
  babyTree_->Branch("HLT50_prescale",      &HLT_prescale_Photon50_L1R_,     "HLT50_prescale/I");  
  babyTree_->Branch("HLT70_prescale",      &HLT_prescale_Photon70_L1R_,     "HLT70_prescale/I"); 
