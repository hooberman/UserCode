...
process.poolDBESSource = cms.ESSource("PoolDBESSource",
  ...
  DBParameters = cms.PSet(
   ...
   toGet = cms.VPSet(cms.PSet(
       ...
       tag = cms.string('SiStripShiftAndCrosstalk_Ideal_v1_mc')
   ))
)

process.es_prefer_GlobalTag = cms.ESPrefer('PoolDBESSource','poolDBESSource')
