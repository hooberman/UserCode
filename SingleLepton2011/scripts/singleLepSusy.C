...
TCut selection_TCut( bool highpt ){
  ...
  //highptsel = highptsel + ( highmet || highht );
...
pair<float,float> ABCDprime( char* path , string sample , bool latex , float metcutval , float htcutval , bool print  ){
