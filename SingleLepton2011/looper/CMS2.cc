...
namespace tas {
	...
	TString &evt_dataset() { return cms2.evt_dataset(); }
        ...
        //ADDED SPARM!
	TString &sparm_comment() { return cms2.sparm_comment(); }
	float &sparm_mG() { return cms2.sparm_mG(); }
	float &sparm_mL() { return cms2.sparm_mL(); }
	float &sparm_mf() { return cms2.sparm_mf(); }
