...
void trainMVA_smurf( int mH , TString myMethodList = "" )
{
  ...
  chbackground->Add(Form("%s/ww.root"     ,babyPath));
  //   chbackground->Add(Form("%s/ggww.root"   ,babyPath));
  //   chbackground->Add(Form("%s/wz.root"     ,babyPath));
  //   chbackground->Add(Form("%s/zz.root"     ,babyPath));
  //   chbackground->Add(Form("%s/ttbar.root"  ,babyPath));
  //   chbackground->Add(Form("%s/wjets.root"  ,babyPath));
  //   chbackground->Add(Form("%s/dyee.root"   ,babyPath));
  //   chbackground->Add(Form("%s/dymm.root"   ,babyPath));
  //   chbackground->Add(Form("%s/dytt.root"   ,babyPath));
  //   chbackground->Add(Form("%s/tw.root"     ,babyPath));
  ...
  if     ( mH == 130 )      chsignal->Add(Form("%s/hww130.root",    babyPath));
  else if( mH == 160 )      chsignal->Add(Form("%s/hww160.root",    babyPath));
  else if( mH == 200 )      chsignal->Add(Form("%s/hww200.root",    babyPath));
  else if( mH == 250 )      chsignal->Add(Form("%s/hww250.root",    babyPath));
  else{
    std::cout << "Error, unrecognized higgs mass " << mH << " GeV, quitting" << std::endl;
    exit(0);
  }
  ...
  TString outfileName( "trainMVA_smurf.root" );
  ...
  //factory->AddSpectator( "evtype",  "Event Type", "units", 'F' );
  ...
  signal->SetBranchAddress( "evtype"      , &evtype       );
...
//     cout << endl;
//     cout << "Event   " << i << " " << event << " weight " << scale1fb << endl;
//     cout << "lep1pt  " << lep1->pt()    << endl;
//     cout << "lep2pt  " << lep2->pt()    << endl;
//     cout << "dPhi    " << dPhi          << endl;
//     cout << "dilmass " << dilep->mass() << endl;
//     cout << "type    " << type          << endl;
//     cout << "pmet    " << pmet          << endl;
//     cout << "met     " << met           << endl;
//     cout << "mt      " << mt            << endl;
//     cout << "mt1     " << mt1           << endl;
//     cout << "mt2     " << mt2           << endl;
//     cout << "dphi1   " << dPhiLep1MET   << endl;
//     cout << "dphi2   " << dPhiLep2MET   << endl;
...
//     }
  ...
  background->SetBranchAddress( "evtype"      , &evtype       );  
