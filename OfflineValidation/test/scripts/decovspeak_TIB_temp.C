...
MyStrip->cd();
TH1F *dupeak=        cloneHist(h_Xprime_TIBBarrel_3);
TH1F *dwpeak=        cloneHist(h_resXprimeOverTheta_TIBBarrel_3);
TH1F *dttimepeak=    (TH1F*)h_dttime_TIBBarrel_3->Clone();
TH1F *dttimeerrpeak= (TH1F*)h_dttimeerr_TIBBarrel_3->Clone();
TH1F *ndtpeak=       (TH1F*)h_ndt_TIBBarrel_3->Clone();
TH1F *chargepeak=    (TH1F*)h_charge_TIBBarrel_3->Clone(); 
TH1F *nstripspeak=   (TH1F*)h_nstrips_TIBBarrel_3->Clone(); 

fdeco.cd();
TrackerOfflineValidation->cd();
MyStrip->cd();
TH1F *dudeco=        cloneHist(h_Xprime_TIBBarrel_3);
TH1F *dwdeco=        cloneHist(h_resXprimeOverTheta_TIBBarrel_3);
TH1F *dttimedeco=    (TH1F*)h_dttime_TIBBarrel_3->Clone();
TH1F *dttimeerrdeco= (TH1F*)h_dttimeerr_TIBBarrel_3->Clone();
TH1F *ndtdeco=       (TH1F*)h_ndt_TIBBarrel_3->Clone();
TH1F *chargedeco=    (TH1F*)h_charge_TIBBarrel_3->Clone(); 
TH1F *nstripsdeco=   (TH1F*)h_nstrips_TIBBarrel_3->Clone(); 
...
TrackerOfflineValidation->cd();
MyStrip->cd();
TH2F* duthetapeak =  (TH2F*)h_resXprimeVsTheta_TIBBarrel_3->Clone();
//TH2F* dutrkpeak =  (TH2F*)h_duvstrkangle_TIBBarrel_3->Clone();
//TH2F* dulorpeak =  (TH2F*)h_duvslorangle_TIBBarrel_3->Clone();
TH2F* duvsdtpeak =   (TH2F*)h_duvsdttime_TIBBarrel_3->Clone();
TH2F* dwvsdtpeak =   (TH2F*)h_dwvsdttime_TIBBarrel_3->Clone();
TH2F* chvsdtpeak = (TH2F*)h_chargevsdttime_TIBBarrel_3->Clone();

fdecoTH2.cd();
TrackerOfflineValidation->cd();
MyStrip->cd();
TH2F* duthetadeco =  (TH2F*)h_resXprimeVsTheta_TIBBarrel_3->Clone();
//TH2F* dutrkdeco =  (TH2F*)h_duvstrkangle_TIBBarrel_3->Clone();
//TH2F* dulordeco =  (TH2F*)h_duvslorangle_TIBBarrel_3->Clone();
TH2F* duvsdtdeco =   (TH2F*)h_duvsdttime_TIBBarrel_3->Clone();
TH2F* dwvsdtdeco =   (TH2F*)h_dwvsdttime_TIBBarrel_3->Clone();
TH2F* chvsdtdeco = (TH2F*)h_chargevsdttime_TIBBarrel_3->Clone();
