...
MyStrip->cd();
TH1F *dupeak=        cloneHist(h_Xprime_TIDEndcap_1);
TH1F *dwpeak=        cloneHist(h_resXprimeOverTheta_TIDEndcap_1);
TH1F *dttimepeak=    (TH1F*)h_dttime_TIDEndcap_1->Clone();
TH1F *dttimeerrpeak= (TH1F*)h_dttimeerr_TIDEndcap_1->Clone();
TH1F *ndtpeak=       (TH1F*)h_ndt_TIDEndcap_1->Clone();
TH1F *chargepeak=    (TH1F*)h_charge_TIDEndcap_1->Clone(); 
TH1F *nstripspeak=   (TH1F*)h_nstrips_TIDEndcap_1->Clone(); 

fdeco.cd();
TrackerOfflineValidation->cd();
MyStrip->cd();
TH1F *dudeco=        cloneHist(h_Xprime_TIDEndcap_1);
TH1F *dwdeco=        cloneHist(h_resXprimeOverTheta_TIDEndcap_1);
TH1F *dttimedeco=    (TH1F*)h_dttime_TIDEndcap_1->Clone();
TH1F *dttimeerrdeco= (TH1F*)h_dttimeerr_TIDEndcap_1->Clone();
TH1F *ndtdeco=       (TH1F*)h_ndt_TIDEndcap_1->Clone();
TH1F *chargedeco=    (TH1F*)h_charge_TIDEndcap_1->Clone(); 
TH1F *nstripsdeco=   (TH1F*)h_nstrips_TIDEndcap_1->Clone(); 
...
TrackerOfflineValidation->cd();
MyStrip->cd();
TH2F* duthetapeak =  (TH2F*)h_resXprimeVsTheta_TIDEndcap_1->Clone();
//TH2F* dutrkpeak =  (TH2F*)h_duvstrkangle_TIDEndcap_1->Clone();
//TH2F* dulorpeak =  (TH2F*)h_duvslorangle_TIDEndcap_1->Clone();
TH2F* duvsdtpeak =   (TH2F*)h_duvsdttime_TIDEndcap_1->Clone();
TH2F* dwvsdtpeak =   (TH2F*)h_dwvsdttime_TIDEndcap_1->Clone();
TH2F* chvsdtpeak = (TH2F*)h_chargevsdttime_TIDEndcap_1->Clone();

fdecoTH2.cd();
TrackerOfflineValidation->cd();
MyStrip->cd();
TH2F* duthetadeco =  (TH2F*)h_resXprimeVsTheta_TIDEndcap_1->Clone();
//TH2F* dutrkdeco =  (TH2F*)h_duvstrkangle_TIDEndcap_1->Clone();
//TH2F* dulordeco =  (TH2F*)h_duvslorangle_TIDEndcap_1->Clone();
TH2F* duvsdtdeco =   (TH2F*)h_duvsdttime_TIDEndcap_1->Clone();
TH2F* dwvsdtdeco =   (TH2F*)h_dwvsdttime_TIDEndcap_1->Clone();
TH2F* chvsdtdeco = (TH2F*)h_chargevsdttime_TIDEndcap_1->Clone();
