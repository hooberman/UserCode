...
calotoweroptmaker.HBThreshold = cms.double(0.5)    #<<<---lowered threshold
calotoweroptmaker.HESThreshold = cms.double(0.7)   #<<<---lowered threshold
calotoweroptmaker.HEDThreshold = cms.double(0.5)   #<<<---lowered threshold
