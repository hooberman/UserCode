...
(to remove overlap with the dilepton trigger sample). 
...
{\bf NO CORRECTION FOR TRUE LEPTON CONTAMINATION APPLIED HERE, TO BE FIXED}.
...
{\bf NEED TO APPLY SPILLAGE CORRECTION. SUBTRACT 2 X DOUBLE FAKES FROM SINGLE FAKES. PUT 50\% SYST}
}
