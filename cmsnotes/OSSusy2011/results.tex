...
by the correction factors determined in Sec.~\ref{sec:datadriven}, as summarized in Table~\ref{tab:abcd}.
...
\hline
2010 signal region      &      3     &   $0.4 \pm 0.3$   &  1.5   &   $1.4 \pm 0.2$  & X $\pm$ X (stat) $\pm$ X (syst) \\
