...
where $R_{\mu e} = 1.12 \pm 0.05$ is the ratio of muon to electron selection efficiencies.
...
subtraction technique we also apply the $Z$ mass veto to the $e\mu$ channel. The
...
and the quantity $\Delta = R_{\mu e}N(ee) + \frac{1}{R_{\mu e}}N(\mu\mu) - N(e\mu)$ which is predicted
to be consistent with 0 for \ttbar. The quoted systematic uncertainty refers to that of $R_{\mu e} = 1.14 \pm 0.05$.
}
\begin{tabular}{lcccccccc}
\hline
