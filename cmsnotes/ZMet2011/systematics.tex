...
{\bf Temporary note to readers: the above values have not yet been propagated to the tables below. The old value of 3.6\% is still used below. We will update the tables shortly.}
