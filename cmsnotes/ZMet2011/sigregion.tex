...
\begin{figure}[hbt]
\begin{center}
%despite the name of the file, it's actually met 100
\includegraphics[width=0.48\linewidth]{plots/hdilmass_pfmet60_ee_allj.png}
\includegraphics[width=0.48\linewidth]{plots/hdilmass_pfmet60_mm_allj.png}
