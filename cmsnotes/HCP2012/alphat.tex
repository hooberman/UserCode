...
%%% <<<--------- LEFT OFF HERE
%The key feature of the \alphat\ variable is that mismeasurement effects tend to decrease the value of \alphat; as a result,
%the \alphat\ distribution for events with fake \met\ decreases rapidly at $\alpha_T\approx0.5$, as shown in Fig.~\ref{fig:alphat}(a). 
