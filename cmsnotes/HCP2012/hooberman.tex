...
\begin{document}
%
\title{Searches for Top and Bottom Squarks in pp Collisions at $\sqrt{s}=8$~TeV}
%
...
\abstract{%
  ...
  not larger than several hundred GeV. This note describes three searches for the direct pair production
  of these particles, based on a sample of pp collisions data corresponding to approximately 10~fb$^{-1}$ collected by the Compact
  Muon Solenoid detector at the LHC, at a center-of-mass energy $\sqrt{s}=8$~TeV. The searches are performed
