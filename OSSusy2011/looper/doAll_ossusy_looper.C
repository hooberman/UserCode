  ...
  if(runDYtot){
    ...
    if( useMCSkims ){
      ...
      pickSkimIfExists(chDYtot, 
		       "/nfs-7/userdata/cms2/DYToTauTau_M-20_CT10_TuneZ2_7TeV-powheg-pythia-tauola_Summer11-PU_S4_START42_V11-v1/V04-02-29/merged_ntuple.root",
		       "DYtot");
