...
void runTCMETLooperTemplate(char* prefix){
  ...
  if     ( strcmp( prefix , "zee" )   == 0 ){
    ...
    ch->Add( "/tas01/disk01/cms2/MinimumBias_Commissioning10-GOODCOLL-v8/merged_ntuple*0.root" );
    isData = true;
  }
  ...
  else if( strcmp( prefix , "dipion" )  == 0 ){  
    ch->Add( "/tas/cms2/DiPion_E1to300_Spring10-START3X_V26_S09-v1/V03-04-13-01/merged_ntuple_1.root" );
  }
