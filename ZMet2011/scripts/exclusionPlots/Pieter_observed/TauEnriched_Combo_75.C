TGraph * Tau75_observed(){
  ...
  double yy_obs[] = {0 , 25 , 50 , 75 , 100 , 125 , 125 , 150 , 150 , 175 , 175 , 175 , 175 , 175 , 150 , 125 , 100 , 75 , 50 , 25 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , 25 , 50 , 75};
  TGraph* observed = new TGraph(37, xx_obs, yy_obs);
  return observed;
}

TGraph * Tau75_observedup(){
  ...
  double yy_theoryup[] = {0 , 23.7873 , 52.2361 , 78.5355 , 103.536 , 129.472 , 129.472 , 154.472 , 154.472 , 179.472 , 180 , 180 , 180 , 179.472 , 152.236 , 125 , 102.236 , 77.2361 , 47.7639 , 25 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , 23.7873 , 52.2361};
  TGraph* observed_theoryup = new TGraph(36, xx_theoryup, yy_theoryup);
  return observed_theoryup;
}

TGraph * Tau75_observeddown(){
  ...
  double yy_theorydown[] = {0 , 26.2127 , 47.7639 , 71.4645 , 96.4645 , 120.528 , 120.528 , 145.528 , 145.528 , 170.528 , 170 , 170 , 170 , 170.528 , 147.764 , 125 , 97.7639 , 72.7639 , 52.2361 , 25 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , -50 , 26.2127 , 47.7639};
